...
public interface IApiActions extends IApiContext {
    ...
    /**
     * Motor Metot: İsteklerin nasıl atılacağı, Retry mantığı ve Allure loglama
     * bu metodun arkasında BaseApi tarafından yönetilir.
     */
